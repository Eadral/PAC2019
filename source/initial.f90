...
! !USES:
   ...
   use distribution, only: init_mic_proc_flag
...
!   write(6,*)'xiaobin initialize_POP1,my_task+1',my_task+1
   call init_grid2
!   write(6,*)'xiaobin initialize_POP2,my_task+1',my_task+1
...
!-----------------------------------------------------------------------
   ...
   call init_timers
!   write(6,*)'xiaobin initialize_POP3,my_task+1',my_task+1
   call init_global_reductions
!   write(6,*)'xiaobin initialize_POP4,my_task+1',my_task+1
...
!   write(6,*)'xiaobin initialize_POP5,my_task+1',my_task+1
...
!-----------------------------------------------------------------------
   ...
   !call init_state
!   write(6,*)'xiaobin initialize_POP6,my_task+1',my_task+1
...
!   write(6,*)'xiaobin initialize_POP7,my_task+1',my_task+1
   !call init_horizontal_mix
!   write(6,*)'xiaobin initialize_POP8,my_task+1',my_task+1
...
!-----------------------------------------------------------------------
   ...
   !call init_advection
!   write(6,*)'xiaobin initialize_POP9,my_task+1',my_task+1
...
!   write(6,*)'xiaobin initialize_POP10,my_task+1',my_task+1
...
!   write(6,*)'xiaobin initialize_POP12,my_task+1',my_task+1
   !call init_baroclinic
!   write(6,*)'xiaobin initialize_POP13,my_task+1',my_task+1
   !call init_barotropic
!   write(6,*)'xiaobin initialize_POP14,my_task+1',my_task+1
   !call init_surface_hgt

!   write(6,*)'xiaobin initialize_POP15,my_task+1',my_task+1
!-----------------------------------------------------------------------
!
